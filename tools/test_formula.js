...
const cases = [
  ...
  ["{安装国家}", ""],
  ["固定文字", "固定文字"],
  ["=TEXT({凭证日期},\"yyyy-mm-dd\")", "2026-08-31"],
  ["=TEXT({交货日期},\"yyyymmdd\")", "20260909"],
  ["=TEXT({凭证日期},\"yyyy/mm/dd\")", "2026/08/31"],
  ["=TEXT({十六},\"yyyy/m/d\")", "2026/9/16"],
  ["=TEXT({单日},\"yyyy/m/d\")", "2026/9/1"],
  ["=TEXT({交货日期},\"yyyy/m/d\")", "2026/9/9"],
  ["=DATEVALUE({凭证日期})", "2026-08-31"],
];
